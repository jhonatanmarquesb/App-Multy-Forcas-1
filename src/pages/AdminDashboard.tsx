                    ...
                    <div className="space-y-3">
                      {loading ? (
                        ...
                        filteredUsers.map(user => (
                          <div key={user.id || user.uid} className="bg-zinc-900/40 backdrop-blur-md p-5 rounded-3xl flex flex-wrap gap-4 justify-between items-center border border-zinc-800/30 group hover:border-[#FFD700]/30 transition-all">
                            <div className="flex items-center gap-4 min-w-0">
                              <div className="w-10 h-10 shrink-0 bg-black rounded-xl flex items-center justify-center border border-zinc-800 text-zinc-600 group-hover:text-[#FFD700] transition-colors">
                                <User size={20} />
                              </div>
                              <div className="min-w-0">
                                <div className="font-bold text-white group-hover:text-[#FFD700] transition-colors truncate">{user.name}</div>
                                <div className="text-[10px] text-zinc-500 font-black uppercase tracking-tighter mt-0.5 flex items-center gap-2 flex-wrap">
