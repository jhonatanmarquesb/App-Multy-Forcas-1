...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      {/* Luzes de fundo */}
      <div className="absolute top-[-10%] right-[-10%] w-[45%] h-[45%] bg-[#FFD700]/6 blur-[120px] rounded-full ambient-glow" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[35%] h-[35%] bg-[#FFD700]/6 blur-[100px] rounded-full ambient-glow" style={{ animationDelay: '-6s' }} />
