    ...
    <div className="p-6 pt-12 max-w-2xl mx-auto">
      <header className="flex justify-between items-center mb-8">
        <div>
          ...
          <h1 className="text-3xl font-display uppercase text-white leading-tight">
            {workout?.title || 'Multy Forças'}
          </h1>
          <p className="text-zinc-500 text-xs font-medium uppercase tracking-wider flex items-center gap-2 mt-1.5">
            <UserCheck size={12} className="text-[#FFD700]" />
            Prof: {workout?.teacherName || 'Equipe Multy'}
          </p>
        </div>
        <motion.div
          whileTap={{ scale: 0.92 }}
          className="flex items-center gap-2 bg-zinc-900 border border-zinc-800 px-4 py-2 rounded-2xl shadow-xl"
